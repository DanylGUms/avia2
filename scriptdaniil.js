...
// GAME VARIABLES
  ...
  function updateDistense(){
    game.distance+=game.speed*deltaTime*game.ratioSpeedDistance; // было game.deltaTime вместо просто deltaTime
  ...
  var fieldDistance, fieldLevel, levelCircle, energyBar, replayMassege
      
    function init(event){
    document.addEventListener('mousemove', handleMouseMove, false);
    fieldDistance = document.getElementById("distValue"); // было DistValue вместо distValue
    fieldLevel = document.getElementById("levelValue");
    levelCircle = document.getElementById("levelCircleStroke"); // было levelCirculeStroke вместо levelCircleStroke
    resetGame();
    //moveUp(); лишний вызов функции
    createScene();
    createLights();
    createPlane();
    createAnimatedSmoke();
